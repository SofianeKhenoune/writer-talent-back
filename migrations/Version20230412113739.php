 ...
 */
final class Version20230412113739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test (user_id INT NOT NULL, post_id INT NOT NULL, INDEX IDX_D87F7E0CA76ED395 (user_id), INDEX IDX_D87F7E0C4B89032C (post_id), PRIMARY KEY(user_id, post_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ToReadLater (user_id INT NOT NULL, post_id INT NOT NULL, INDEX IDX_947B6802A76ED395 (user_id), INDEX IDX_947B68024B89032C (post_id), PRIMARY KEY(user_id, post_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
